...
namespace rapidcsv
{
    ...
    struct LabelParams
    {
         ...
         *                                to all rows as processXML data. Default: 0
         ...
         *                                to all columns as processXML data. Default: -1
         */
    ...
    struct SeparatorParams
    {
         ...
         * @param   pHasCR                specifies whether a new document (i.e. not an existing processXML read)
    ...
    /**
     * @brief     Class representing a CSV processXML.
     */
    class Document
    {
    public:
